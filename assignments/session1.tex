...
Above, we described how to use Codespaces, work with Jupyter notebooks, and commit and push your changes to your repository on GitHub. Now proceed with the tasks below.
\begin{enumerate}
