...
\begin{enumerate}
    \item Load the first image\footnote{\url{https://www.cellpose.org/dataset}} as given in the notebook, resize it to (256, 256) pixels using the \texttt{resize()} function, and show the result.
...
\begin{enumerate}
    \item Load the image \texttt{data/brain\_ct.png}\footnote{\url{https://brain-development.org/ixi-dataset}}.
